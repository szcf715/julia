 ...
 *     (the function may have multiple pointers corresponding to different versions).
 *     In other sysimg info, all information of functions are stored function index which are
 ...
 *     the base function offsets instead.
 ...
 *     A tagged index means that the function address should be filled into the GOT slots
 ...
 *     and used alone with `jl_dispatch_fvars_idxs`.
